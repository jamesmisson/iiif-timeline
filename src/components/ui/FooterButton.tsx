  ...
  return (
    <div className="relative inline-block h-[30px]">
      ...
      {title && (
        <div
          role="tooltip"
          className={`absolute left-1/2 bottom-[38px] transform -translate-x-1/2 whitespace-nowrap bg-gray-800 text-white px-2 py-1 text-sm rounded z-[1000] pointer-events-none transition-all duration-200 ease-in-out
      ...
      <button
        ...
        className={`w-[30px] h-[30px] p-0 inline-flex items-center justify-center border-none bg-transparent z-[1000] transition-colors duration-120 ease-in-out
      ...
      >
        <div
          className={`w-full h-full transition-colors duration-120 ease-in-out
            ${disabled ? "opacity-20" : "fill-white hover:fill-cyan-300"}`}
        >
          {children}
        </div>
      </button>
